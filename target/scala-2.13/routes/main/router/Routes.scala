...
class Routes(
  ...
  def documentation = List(
    ...
    ("""GET""", this.prefix + (if(this.prefix.endsWith("/")) "" else "/") + """deletePerson/""" + "$" + """id<[^/]+>""", """controllers.PersonController.detetePerson(id:Long)"""),
  ...
  // @LINE:9
  private[this] lazy val controllers_PersonController_detetePerson3_route = Route("GET",
    PathPattern(List(StaticPart(this.prefix), StaticPart(this.defaultPrefix), StaticPart("deletePerson/"), DynamicPart("id", """[^/]+""",true)))
  )
  private[this] lazy val controllers_PersonController_detetePerson3_invoker = createInvoker(
    PersonController_1.detetePerson(fakeValue[Long]),
    play.api.routing.HandlerDef(this.getClass.getClassLoader,
      "router",
      "controllers.PersonController",
      "detetePerson",
  ...
  def routes: PartialFunction[RequestHeader, Handler] = {
    ...
    // @LINE:9
    case controllers_PersonController_detetePerson3_route(params@_) =>
      call(params.fromPath[Long]("id", None)) { (id) =>
        controllers_PersonController_detetePerson3_invoker.call(PersonController_1.detetePerson(id))
      }
